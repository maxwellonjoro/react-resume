export const Data = {
  profile: {
    ...
    email: "onjoromaxwell@gmail.com",
    telephone: "+254723049107",
  ...
  socialMedia: {
    ...
    social: [
      {
        label: "Maxwell Onjoro",
        name: "linkedin",
        url: "https://www.linkedin.com/in/maxwell-onjoro-3ba08878",
        className: "bxl-linkedin-square",
      },
      {
        label: "maxwellonjoro",
        name: "github",
        url: "https://github.com/maxwellonjoro",
        className: "bxl-github",
      },
      {
        label: "@maxwellonjoro",
        name: "twitter",
        url: "https://twitter.com/maxwellonjoro",
  ...
  experience: {
    works: [
      ...
      {
        title: "Software Developer",
        company: "Stonehouse Technologies",
    ...
    academic: [
      {
        career: "BSc Computer Engineering",
        date: "2007 - 2012",
